...
export default function BottomBannerAd({ className = '' }: BottomBannerAdProps) {
  ...
  return (
    <div
      className={`bottom-banner-ad fixed bottom-0 left-0 right-0 z-[100] bg-white border-t-2 border-gray-300 shadow-2xl ${className}`}
      role="complementary"
      ...
      <div className="container-custom py-3">
        <div className="relative flex items-center justify-center">
          ...
          <div className="w-full max-w-5xl mx-auto">
            <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg h-24 md:h-32 flex items-center justify-center">
              <div className="text-center text-gray-400 text-sm">
                <p className="font-medium">Advertisement</p>
                <p className="text-xs mt-1">728x90 / 970x250 Banner</p>
                <p className="text-xs mt-1 text-gray-300">Bottom Banner Ad</p>
              </div>
            </div>
          </div>
        </div>
